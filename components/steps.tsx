...
export const steps = () => {
  return (
    <div className="pt-24 md:pt-48">
      <div className="pb-8 md:flex flex-col md:flex-row justify-center items-center px-4">
        <Image src={Doors} width={550} alt={""} />
        <div className="md:ml-[120px] mt-4 md:mt-0 px-4 sm:px-0">
          <p className="text-center md:text-left text-xl font-semibold pb-4">
            Step 01
          </p>
      ...
      <div className="pb-8 md:flex flex-col justify-center md:flex-row-reverse items-center pt-8 px-4">
        <Image src={Kitchen} alt="" width={550} />
        <div className="md:mr-[120px] mt-4 md:mt-0 px-4 sm:px-0">
          <p className="text-center md:text-left text-xl font-semibold pb-4">
            Step 02
          </p>
          <p className="text-center md:text-left text-2xl font-bold pb-3">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center pt-8 px-4">
        ...
        <div className="md:ml-[120px] mt-4 md:mt-0 px-4 sm:px-0">
          ...
          <p className="text-center md:text-left text-2xl font-bold pb-4">
            Installation
          </p>
          <p className="text-center md:text-left text-base md:w-[37rem]">
