    ...
    <div className="pt-12 md:pt-48">
      <div className="flex flex-col md:flex-row justify-center items-center px-4">
        ...
        <div className="md:ml-[120px] mt-4 md:mt-0">
          <p className="text-xl font-semibold pb-4">Step 01</p>
          <p className="text-2xl font-bold pb-3">
            Pick From Our Wide Selection
          </p>
          <p className="text-base md:w-[37rem]">
      ...
      <div className="flex flex-col justify-center md:flex-row-reverse items-center pt-20 px-4">
        <Image src={Kitchen} alt="" width={550} />
        <div className="md:mr-[120px] mt-4 md:mt-0">
          <p className="text-xl font-semibold pb-4">Step 02</p>
          <p className="text-2xl font-bold pb-3">Design Your Dream Kitchen</p>
          <p className="text-base md:w-[37rem]">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center pt-20 px-4">
        ...
        <div className="md:ml-[120px] mt-4 md:mt-0">
          <p className="text-xl font-semibold pb-4">Step 03</p>
          <p className="text-2xl font-bold pb-4">Installation</p>
          <p className="text-base md:w-[37rem]">
